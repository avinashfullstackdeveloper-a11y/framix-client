...
const UserStats = ({ stats }: { stats: UserStats }) => (
  <div className="flex items-center gap-8">
    <div className="flex items-center gap-2 bg-secondary/40 rounded-xl py-2 px-4">
      <div className="text-xl">{statsIcons.posts}</div>
    ...
    <div className="flex items-center gap-2 bg-secondary/40 rounded-xl py-2 px-4">
      <div className="text-xl w-5 h-5 flex items-center justify-center">
        {statsIcons.views}
      </div>
      <div className="flex flex-col">
  ...
  return (
    <div className="relative w-full max-w-7xl mx-auto bg-gradient-card rounded-3xl border border-border shadow-lg p-8 pt-20 pb-12 mt-12 mb-8">
      ...
      <div className="absolute top-6 left-8">
        <button
          className="flex items-center gap-2 px-4 py-2 rounded-md hover:bg-gray-800 transition-colors text-white"
          onClick={handleGoBack}
        >
          <svg width="16" height="17" viewBox="0 0 16 17" fill="none">
            <path d="M5.88667 4.66504C4.48742 5.69958 3.22806 6.91099 2.14 8.26904C2.0496 8.38125 2.00021 8.52095 2 8.66504M2 8.66504C2.00021 8.80913 2.0496 8.94883 2.14 9.06104C3.22807 10.4191 4.48743 11.6305 5.88667 12.665M2 8.66504H14" stroke="currentColor" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
