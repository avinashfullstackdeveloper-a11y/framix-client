      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="flex flex-col">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
            {/* Company Links */}
            <div>
              <h3 className="text-base font-semibold text-white mb-5">Company</h3>
              <ul className="space-y-4">
                <li><a href="#" className="text-base text-gray-400 hover:text-white">About</a></li>
                <li><a href="#" className="text-base text-gray-400 hover:text-white">Career</a></li>
                <li><a href="#" className="text-base text-gray-400 hover:text-white">Contact</a></li>
                <li><a href="#" className="text-base text-gray-400 hover:text-white">Legal</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li><a href="#" className="text-base text-gray-400 hover:text-white">Components</a></li>
                <li><a href="#" className="text-base text-gray-400 hover:text-white">Templates</a></li>
                <li><a href="#" className="text-base text-gray-400 hover:text-white">UI Kits</a></li>
            ...
            {/* Resources Links */}
            <div>
              <h3 className="text-base font-semibold text-white mb-5">Resources</h3>
              <ul className="space-y-4">
                <li><a href="#" className="text-base text-gray-400 hover:text-white">Documentation</a></li>
                <li><a href="#" className="text-base text-gray-400 hover:text-white">Case Studies</a></li>
