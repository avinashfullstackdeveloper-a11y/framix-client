...
const CommunityList = () => {
    ...
    const fetchComponents = async () => {
      try {
        ...
        const response = await fetch(
          `${import.meta.env.VITE_API_URL}/api/components?excludeScraped=true&fields=_id,title,type,badge,views,likeCount,commentCount,createdBy,author,category,description,preview,likedBy,comments,isPro,isFree,tags,createdAt,updatedAt`,
          {
            credentials: "include",
          }
        );
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                      ...
                      <CardContent className="p-0">
                        ...
                        >
                          ...
                          <div className="absolute top-3 right-3 z-10">
                            <Badge
                              variant="secondary"
                              className="bg-black/50 text-white backdrop-blur-sm badge-hover-effect"
                            >
                        ...
                        <div className="p-4">
                          <div className="flex items-center justify-between gap-2">
                            ...
                            >
                              ...
                              />
                              <div className="min-w-0 flex-1">
                                <div className="text-sm font-medium truncate username-hover-effect">
                                  {(() => {
                                    const name =
                                      component.createdBy?.name ||
                                      component.author?.name;
      ...
      {/* CTA Section */}
      <div className="text-center py-16 bg-black rounded-2xl border border-border">
