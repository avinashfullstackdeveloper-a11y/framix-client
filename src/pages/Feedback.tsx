    ...
    <main className="flex flex-col items-center min-h-screen w-full px-4 pt-6">
      ...
      <div className="flex flex-col items-center w-full max-w-[465px]">
        <form onSubmit={handleSubmit} className="flex flex-col items-center w-full">
          ...
          <button
            type="submit"
            className="bg-[rgba(235,142,185,1)] flex min-h-12 w-full items-center justify-center text-sm text-black font-semibold leading-none mt-8 px-[13px] py-3.5 rounded-[30px] hover:bg-[rgba(225,132,175,1)] transition-colors focus:outline-none focus:ring-2 focus:ring-[rgba(255,154,201,0.6)]"
          >
            Submit Feedback
          </button>
        </form>
